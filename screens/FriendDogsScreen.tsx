...
const styles = StyleSheet.create({
  ...
  emptyText: { textAlign: 'center', color: '#000', marginTop: 60, fontSize: 16 },
  card: {
  ...
  dogName: { fontSize: 18, fontWeight: 'bold', color: '#000' },
  compatEmoji: { fontSize: 14, color: '#000' },
  detail: { fontSize: 14, color: '#000', marginBottom: 4 },
  ...
  metButtonText: { fontSize: 14, color: '#000', fontWeight: 'bold' },
  metButtonTextActive: { color: '#00B894' },
  modal: { flex: 1, backgroundColor: '#fddb13' },
  ...
  compatOptionLabel: { fontSize: 12, color: '#000', marginTop: 4 },
